...
const AdminRequestsPage = () => {
    ...
    const fetchAllRequests = useCallback(async () => {
        ...
        try {
            ...
            const rawData = getResponseCollection(response);
            ...
            console.error('خطأ في جلب بيانات الطلبات:', err);
            setRequests([]);
            setError(getApiErrorMessage(err, 'فشل تحميل سجل الطلبات.'));
        } finally {
            setLoading(false);
        }
    }, []);
        ...
        <div style={{ padding: '20px', backgroundColor: '#f8fafc', minHeight: '100vh', direction: 'rtl' }}>
            ...
            <div style={{ backgroundColor: '#fff', borderRadius: '10px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)', overflow: 'hidden' }}>
                {loading ? (
                    ...
                    <div style={{ padding: '50px', textAlign: 'center', color: '#ef4444', fontWeight: '700' }}>
                        <p>{error}</p>
                        <button
                            type="button"
