    ...
    <div class="bg-white rounded-2xl shadow-xl max-w-md w-full overflow-hidden border-t-8 border-green-500">
        ...
        <div class="p-6 space-y-4">
            <div class="border-b pb-3">
                ...
                <p class="font-bold text-gray-800">{{ $data['request_number'] }}</p>
            </div>
            <div class="border-b pb-3">
                <p class="text-xs text-gray-500">اسم المواطن</p>
                <p class="font-bold text-gray-800">{{ $data['citizen_name'] }}</p>
            </div>
            <div class="border-b pb-3">
                <p class="text-xs text-gray-500">الرقم الوطني</p>
                <p class="font-bold text-gray-800" style="letter-spacing: 2px;">{{ $data['national_id'] }}</p>
            </div>
            <div class="border-b pb-3">
                <p class="text-xs text-gray-500">نوع الخدمة المعتمدة</p>
                <p class="font-bold text-blue-600">{{ $data['service'] }}</p>
            </div>
            <div>
                <p class="text-xs text-gray-500">تاريخ الإصدار</p>
                <p class="font-semibold text-gray-800">
                    {{ \Carbon\Carbon::parse($data['issued_at'])->format('Y-m-d H:i') }}
                </p>
            </div>
        </div>
